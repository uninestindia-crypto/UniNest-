...
const formSchema = z.object({
  ...
  setupSecret: z.string().min(1, { message: 'Setup secret is required.' }),
});
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      const response = await fetch('/api/admin/promote', {
        ...
        body: JSON.stringify({ email: values.email, setupSecret: values.setupSecret }),
      });
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="password" placeholder="Enter ADMIN_SETUP_SECRET" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
